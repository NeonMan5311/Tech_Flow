function PlaceholderPage({ title, description, actions }) {
  return (
    <main className="mx-auto w-full max-w-6xl px-6 pb-20">
      <section className="rounded-3xl border border-dashed border-slate-700 bg-slate-900/30 px-8 py-12">
        <p className="text-xs font-semibold uppercase tracking-[0.3em] text-emerald-400">Coming soon</p>
